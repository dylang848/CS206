...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Joint(name="FrontLeg_LowerFrontLeg1", parent="FrontLeg1", child="LowerFrontLeg1", type="revolute",
                           position=[0, 1, 0], jointAxis="1 0 0")
        ...
        pyrosim.Send_Joint(name="BackLeg_LowerBackLeg1", parent="BackLeg1", child="LowerBackLeg1", type="revolute",
                           position=[0, -1, 0], jointAxis="1 0 0")
        ...
        pyrosim.Send_Joint(name="RightLeg_LowerRightLeg1", parent="RightLeg1", child="LowerRightLeg1", type="revolute",
                           position=[1, 0, 0], jointAxis="0 1 0")
        ...
        pyrosim.Send_Joint(name="LeftLeg_LowerLeftLeg1", parent="LeftLeg1", child="LowerLeftLeg1", type="revolute",
                           position=[-1, 0, 0], jointAxis="0 1 0")
    ...
    def Generate_Brain(self):
        ...
        for currentRow in range(c.numSensorNeurons):
            for currentColumnn in range(c.numMotorNeurons):
                pyrosim.Send_Synapse(sourceNeuronName=currentRow, targetNeuronName=currentColumnn + c.numSensorNeurons,
                                     weight=self.weights[currentRow][currentColumnn])
